...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/pemesanan.css')); ?>">
    <script>
...
<div class="container">
    ...
    <form action="<?php echo e(url('/bookings')); ?>" method="POST">
        ...
        <input type="email" id="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" required> <!-- Pre-fill email field -->
...
<?php /**PATH C:\xampp\htdocs\kolam_pancing\resources\views/pemesanan.blade.php ENDPATH**/ ?>